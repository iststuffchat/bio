...
document.addEventListener('DOMContentLoaded', () => {
  ...
  homeButton.addEventListener('click', () => {
    switchTheme('https://r2.guns.lol/cc96aec4-c5f1-4414-83ba-4322f6f7d90f.mov', backgroundMusic, 'home-theme');
  });
  ...
  hackerButton.addEventListener('click', () => {
    switchTheme('https://d9fx076u4lynm.cloudfront.net/m6ous4%2Ffile%2F0292942d1c655c149780a16db9ea9bdc_40d45c03d6a85ca41891c8ecbeae9865.mp4?response-content-disposition=inline%3Bfilename%3D%220292942d1c655c149780a16db9ea9bdc_40d45c03d6a85ca41891c8ecbeae9865.mp4%22%3B&response-content-type=video%2Fmp4&Expires=1773920799&Signature=JQDs6vVb2xKRu~x7w7LJ5GjwnMuyYP9nX2~1sjqKaLfTtKi5nu7JR83Vqb59xvl7v9Cuzdk40ewYLiT1xOYf30RWo9gaiGJJKaTUDvL9HtcneA3pF~zoQO8OqYD9hT2dWP7oCkD4SlngAWftskb8mRM5WShtCvO99Zx-muq5AanQBzJp3o64UOQf01OmfXtIrQNQinLZFFctsKLjMJBBArZrBJpzIaM~Icn4lmGLHK-nntZEJYCf9fVcItVuwFNJ2NrtEDQ0DaPqrEsGfr9KNr3QjtXZA0pzBhbFPmu89IXyAPKMR2WXamEzCgRO0VM9XpQp9tmgpT5rQe7S4UzisA__&Key-Pair-Id=APKAJT5WQLLEOADKLHBQ', hackerMusic, 'hacker-theme', hackerOverlay, false);
  });
  ...
  rainButton.addEventListener('click', () => {
    switchTheme('https://r2.guns.lol/a411739c-eb30-4553-9bdd-8fb91cf668ad.mov', rainMusic, 'rain-theme', snowOverlay, true);
  });
  ...
  animeButton.addEventListener('click', () => {
    switchTheme('https://r2.guns.lol/4159d4f9-aad1-4601-8663-a31d3eb0dcbf.mp4', animeMusic, 'anime-theme');
  });
  ...
  carButton.addEventListener('click', () => {
    switchTheme('https://r2.guns.lol/b2a4a23a-0733-4267-8681-bda919dd2e96.mp4', carMusic, 'car-theme');
  });
